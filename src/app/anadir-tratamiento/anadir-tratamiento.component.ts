...
@Component({
  selector: 'anadir-tratamiento',
  templateUrl: './anadir-tratamiento.component.html',
  styleUrls: ['./anadir-tratamiento.component.css']
})
export class AnadirTratamientoComponent implements OnInit {
